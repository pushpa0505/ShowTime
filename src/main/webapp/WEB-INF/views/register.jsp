...
<body class="text-gray-900 flex flex-col min-h-screen">
    ...
    <main class="container mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-grow flex items-center justify-center">
	    <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
	        ...
	        <%-- Code to display success or error messages --%>
	        ...
	        <form:form class="space-y-6" modelAttribute="user" action="register" method="post">
	            <div>
	                <label for="fullName" class="block text-sm font-medium text-gray-700">Full Name</label>
	                <form:input type="text" path="fullName" id="fullName" required="required" class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500"/>
	                <form:errors path="fullName" cssClass="text-red-500 text-sm mt-1"/>
	            </div>
	            <div>
	                <label for="email" class="block text-sm font-medium text-gray-700">Email Address</label>
	                <form:input type="email" path="email" id="email" required="required" class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500"/>
	                <form:errors path="email" cssClass="text-red-500 text-sm mt-1"/>
	            </div>
	            <div>
	                <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
	                <form:password path="password" id="password" required="required" class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500"/>
	            ...
	            <div class="text-center text-sm text-gray-600">
	                <p>Already have an account? <a href="login" class="font-semibold text-red-500 hover:underline">Login here</a></p>
	            </div>
	        </form:form>
	    </div>
	</main>
    ...
    <footer class="bg-white border-t border-gray-200 mt-auto">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mt-8 border-t border-gray-200 pt-6 text-center">
                <p class="text-sm text-gray-500">&copy; 2024 ShowTime. All Rights Reserved.</p>
            </div>
        </div>
    </footer>

				...
				<div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
				    ...
				    <div class="space-y-3 text-gray-800">
				        ...
				        <button class="flex justify-between items-start w-full text-base font-medium toggle-details" data-target="booking-details" data-arrow="booking-arrow">
				            <div class="flex items-center space-x-2 text-gray-900">
				                <span class="text-left leading-tight">Fees & Taxes</span>
				            ...
				            <span class="font-medium text-gray-900 flex-shrink-0">₹<fmt:formatNumber value="${bookingFee + gst}" type="number" minFractionDigits="2" maxFractionDigits="2"/></span>
				        </button>
				        ...
				        <div id="booking-details" class="space-y-3 hidden">
				            ...
				            <div class="flex justify-between items-center text-sm ml-4 text-gray-600">
				                <span>GST</span>
				                <span>₹<fmt:formatNumber value="${gst}" type="number" minFractionDigits="2" maxFractionDigits="2"/></span>
				            </div>
				        </div>
				    </div>

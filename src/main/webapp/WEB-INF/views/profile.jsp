...
<head>
    ...
    <title>My Profile - ShowTime</title>
...
<body class="text-gray-900 flex flex-col min-h-screen">
    ...
    <jsp:include page="header.jsp" />
        ...
        <main class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 flex-grow">
		    ...
		    <div class="flex items-center space-x-4 mb-6 max-w-2xl mx-auto">
		        <a href="${pageContext.request.contextPath}/" class="text-gray-600 hover:text-red-500">
		    ...
		    <div class="max-w-2xl mx-auto">
		        <div class="bg-white p-6 rounded-2xl shadow-lg flex items-center space-x-4 mb-8">
		            <%-- Display the first letter of the user's name --%>
		            <div class="w-12 h-12 rounded-full bg-[#25314C] flex items-center justify-center text-white text-2xl font-bold">
					    <c:out value="${fn:toUpperCase(fn:substring(user.fullName, 0, 1))}" />
					</div>
		        ...
		        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
		            <nav class="divide-y divide-gray-200">
		                <a href="${pageContext.request.contextPath}/profile/edit" class="flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
		                ...
		                <%-- Update the link to point to the booking history page --%>
		                <a href="${pageContext.request.contextPath}/booking-history" class="flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
		                    <div class="flex items-center space-x-4">
		                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
		                        <span class="font-semibold">Your Bookings</span>
		                    </div>
		                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg>
		                </a>
		
		                <%-- Update the link to point to the logout controller --%>
		                <a href="${pageContext.request.contextPath}/logout" class="flex items-center p-4 hover:bg-red-50 transition-colors group">
		                    <div class="flex items-center space-x-4">
		                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" /></svg>
    ...
    <!-- CORRECTED: Footer updated to match index.html -->
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl transform transition-all">
            <div class="p-6">
                ...
                <div class="grid grid-cols-3 sm:grid-cols-5 gap-4">
                    <button class="city-button flex flex-col items-center p-3 bg-violet-50 rounded-lg border-2 border-transparent hover:border-violet-500 transition-colors" data-city="Mumbai">
                        <img src="https://b.zmtcdn.com/data/edition_assets/17436021106764.png" alt="Mumbai" class="h-20 w-20 object-contain">
                    </button>
                    <button class="city-button flex flex-col items-center p-3 bg-violet-50 rounded-lg border-2 border-transparent hover:border-violet-500 transition-colors" data-city="Delhi">
